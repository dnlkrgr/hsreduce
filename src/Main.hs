...
main =
    unwrapRecord "hsreduce" >>= \case
        Reduce {..} -> do
            hsreduce allActions numberOfThreads test sourceFile recordStatistics
        ...
        PackageDesc {..} -> do
            ...
            hsreduce' cabalActions numberOfThreads testAbs filePathAbs fileContent beginState True